...
--
-- Host: localhost:3306
-- Generation Time: Nov 19, 2018 at 05:19 PM
...
CREATE TABLE `patient` (
  ...
  `GPS longitude` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `GPS latitude` varchar(200) NOT NULL,
...
INSERT INTO `patient` (`patientId`, `firstName`, `lastName`, `image`, `age`, `height`, `weight`, `eyeColor`, `hairColor`, `illness`, `doctorName`, `doctorPhone`, `GPS longitude`, `GPS latitude`, `emergencyContact`, `emergencyNo`) VALUES
(1, 'Ralph ', 'Somebody', 'ralph.jpg', 89, '5.4', '180 lbs', 'brown', 'white', 'Dementia, Diabetic, Hypertension', 'Dr Doctor', '905983666', '', '', 'Isabelle Somebody', '9053837483'),
(2, 'Aileen ', 'Somebody', 'aileen.jpg', 78, '5.1', '89 lbs', 'brown', 'grey', 'Altzheimers, Hypertension, Arthritis', 'Dr Doctor', '4167864321', '', '', 'Isabelle Somebody', '7848975432');
...
INSERT INTO `users` (`userId`, `firstName`, `lastName`, `phone`, `password`, `email`, `role`) VALUES
(1, 'Isabelle', 'Somebody', '1234567898', 'IMM2019', 'isabelle.sombody@gmail.com', 2),
